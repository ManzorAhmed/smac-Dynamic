...
{{--            <li><a href="#">Home</a></li>--}}
{{--            <li><a href="{{route('cme-program')}}">{{ $navbar->name }}</a></li>--}}
{{--            <li class="dropdown">--}}
{{--                <a href="#" class="desktop-item">{{ $navbar->name }}</a>--}}
{{--                <input type="checkbox" id="showDrop">--}}
{{--                <label for="showDrop" class="mobile-item">{{ $navbar->name }}</label>--}}
{{--                <ul class="drop-menu">--}}
{{--                    @foreach($navbar->children as $child)--}}
{{--                        <li><a href="{{ $child->link }}" target="_blank">{{ $child->name }}</a></li>--}}
{{--                    @endforeach--}}
{{--                </ul>--}}
{{--            </li>--}}
        ...
        <!-- Rest of the code -->
            <li class="cart-icon">
                ...
                <ul class="drop-menu"
                    ...
                    @else
                        <li class="mini-cart-dropdown empty"
                            style=" font-weight: bold; color: #c10797; font-family: Poppins; font-size: 15px">
