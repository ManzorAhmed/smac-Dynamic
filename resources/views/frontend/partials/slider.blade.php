    ...
    <div class="hero-container">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-inner" role="listbox">
                @foreach($slider as $r)
                    <div class="carousel-item active" style="background-image: url('{{asset('uploads/gallery/'.$r->image)}}')">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown">{{$r->name}}</h2>
                                <p class="animate__animated animate__fadeInUp">{{$r->paragraph}}</p>
                                <a href="{{$r->slug}}"
                                   class="btn-get-started scrollto animate__animated animate__fadeInUp">{{$r->button}}</a>
                            </div>
                        </div>
                    </div>
