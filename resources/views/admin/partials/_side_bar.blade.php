              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                  ...
                  <li class="nav-item">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="{{ route('admin.general.pdf') }}"
                                  class="nav-link {{ request()->is('admin/users') ? 'active' : '' }}">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>
                                      PDF FILE
                  ...
                  <li class="nav-item">
                      <a href="{{ route('pdf.index') }}"
                         class="nav-link {{ request()->is('admin/pdf') ? 'active' : '' }}">
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="{{route('admin.general.message')}}"
                                 class="nav-link {{ request()->is('admin/users') ? 'active' : '' }}">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>
                                      About
                      ...
                      <ul class="nav nav-treeview">
                          <li class="nav-item">
                              <a href="{{route('admin.general.footer')}}"
                                 class="nav-link {{ request()->is('admin/footer') ? 'active' : '' }}">
                                  <i class="far fa-circle nav-icon"></i>
                                  <p>
                                      Footer
                                  </p>
