                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            {{--                            @endif--}}
                            <h4 class="float-left">Order List</h4>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{ url('admin/delete-selected-order') }}" method="post" id="delete-form">
...
{{--                                            <th>Price</th>--}}
                                        ...
                                        @foreach ($orders as $order)
                                            <tr>
                                                <td>
                                                    <div class="checkbox checkbox-success m-0">
                                                        <input id="checkbox{{ $order->id }}" type="checkbox" name="orders[]" value="{{ $order->id }}">
                                                ...
                                                <td>
                                                    <a class="btn btn-info btn-sm" onclick="event.preventDefault(); viewInfo({{ $order->id }});"
                                                       title="View Log" href="javascript:void(0)">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
{{--                                                    <a title="Edit Order" class="btn btn-primary btn-circle"--}}
{{--                                                       href="{{ route('order.edit', $order->id) }}">--}}
{{--                                                        <i class="fa fa-edit"></i>--}}
{{--                                                    </a>--}}
                                                    <a class="btn btn-danger btn-circle" onclick="event.preventDefault(); del({{ $order->id }});"
            ...
            swal.fire({
                ...
                .then((result) => {
                    if (result.value) {
                        $("#delete-form").submit();
                        setTimeout(function () {
                            swal("Order deleted successfully. Thanks");
                        }, 2000);
                    }
                });
        }
